...
const Sidebar = () => {
    return (
        ...
        <div className="chat-section flex gap-4 px-6 group-[abc]: text-sm group-[abc]: text-gray-600 ">
            <div className="all abc border px-3 py-1 rounded-3xl bg-green-200">All</div>
            <div className="unread abc border px-3 py-1 rounded-3xl bg-gray-200">Unread</div>
            <div className="info abc border px-3 py-1 rounded-3xl bg-gray-200">Info</div>
        </div>
